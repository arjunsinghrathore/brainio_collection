...
# BUILD A DIFFERENT AssemblyLoader for SHEINBERG WHERE ONLY ONE XARRAY IS LOADED AND THEN IS MADE SIMILAR TO WHAT"S HAPPENING IN BRAINSCORE
class AssemblyLoader:
    ...
    def load(self):
        ...
        # print('STIMULUS SET : ', stimulus_set)
        # #########################################################
...
# CREATE OWN CLASS/FUNCTION FOR SHEINBERG
_fetcher_types = {
    "S3": BotoFetcher
}
...
# NO NEED FOR THIS FUNCTION if Sheinberg(local)
